...
import edu.adf.adfjmg1.notificaciones.Notificaciones.NOTIFICATION_CHANNEL_ID
import edu.adf.adfjmg1.notificaciones.Notificaciones.NOTIFICATION_CHANNEL_ID3
import edu.adf.adfjmg1.notificaciones.Notificaciones.NOTIFICATION_CHANNEL_NAME3
import edu.adf.adfjmg1.notificaciones.Notificaciones.crearCanalNotificacionForegroundService
...
//            mediaPlayer!!.start()
    ...
    override fun onStartCommand(intent: Intent, flags: Int, startId: Int): Int {
        ...
        if (intent_action == Constantes.STARTFOREGROUND_ACTION) {
            Log.i(Constantes.ETIQUETA_LOG, "Han llamado al servicio para lanzarlo ")
            ...
            /**
             * Obtengo el objeto Remote View, que conformora el Layout de la notificación
 ...
 /*           if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            val notification: Notification = NotificationCompat.Builder(this, NOTIFICATION_CHANNEL_ID3)
...
//                .setContent(notificationView) //la vista personalizada, con sus PendingIntentAsociados
            ...
            Log.i(Constantes.ETIQUETA_LOG, "Petición de parada recibida (onStartCommand)")
    ...
    override fun onDestroy() {
        ...
        Toast.makeText(this, "Parando servicio", Toast.LENGTH_SHORT).show()
        Log.i(Constantes.ETIQUETA_LOG, "Petición de parada recibida (onDestroy)")
