package edu.adf.adfjmg1.googleauth
...
// Create and launch sign-in intent
    ...
    private fun onSignInResult(result: FirebaseAuthUIAuthenticationResult) {
        ...
        if (result.resultCode == RESULT_OK) {
            ...
            Toast.makeText(this, "AUNTENTICACIÓN EXITOSA", Toast.LENGTH_LONG).show()
            mostrarInfoUser(user!!)
            // ...
        } else {
            Log.d(Constantes.ETIQUETA_LOG, "${LogUtil.getLogInfo()} AUTENTICACIÓN FALLIDA")
            Toast.makeText(this, "AUNTENTICACIÓN FALLIDA", Toast.LENGTH_LONG).show()
    ...
    {
        // OJO PARA PODER BORRAR HAY QUE ESTAR LOGUEADO. SI DAMOS ANTES AL SALIR, NO SE BORRA DEL SERVIDOR
        AuthUI.getInstance()
            .delete(this)
            .addOnCompleteListener {
                // ...
