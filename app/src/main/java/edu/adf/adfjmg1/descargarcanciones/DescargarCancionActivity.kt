...
class DescargarCancionActivity : AppCompatActivity() {
    ...
    fun descargarCancion(view: View) {
        Log.d(Constantes.ETIQUETA_LOG, "DESCARGANDO CANCIONES ...")

        // PARTE 1 - PREPARO DESCARGA
        // vamos a descargar la canción Espacio-tiempo del compañero.
